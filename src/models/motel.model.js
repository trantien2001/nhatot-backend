...
const getAllInfoMotelActive = async (req, res) => {
  await sql.query(
    `SELECT
        Title,
        Price,
...
const FilterMotel = async (req, res) => {
...
const updateMotel = async (req, res) => {
  const {
    Title,
    Price,
    Acreage,
